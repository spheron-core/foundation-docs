...
- A public IP is required for the provider to work.
- A domain is required for the provider to work.
- Minimum of 32 CPU, 128 GB RAM and 750 GB+ boot disk is required for the provider to work.
